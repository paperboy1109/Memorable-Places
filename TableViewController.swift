...
class TableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("Cell", forIndexPath: indexPath) // by default "Cell" was "reuseIdentifier"

        // Configure the cell...
        
        //cell.textLabel!.text = "Test" // Rob's code used ?
